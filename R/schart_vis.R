...
#' Visualization of SChart results
#'
#' @param schart_df SChart output meta data, must contain coord_x and coord_y
#' @param img Image data
...
#' @export
#'
#' @examples schart_vis(test_schart@meta.data, test_schart@images[[1]]@image, scale_fac=test_schart@images[[1]]@scale.factors$lowres)
schart_vis <- function(schart_df, img, scale_fac) {
  ...
  app <- list(
    ui=fluidPage(
      titlePanel('SChart visualization'),
      sidebarLayout(sidebarPanel(width=3,
                    ...
                    mainPanel(plotlyOutput('SChart', height='1000px', width='1200px'),
